...
//   return (
//     <div className="bg-white text-[#1a1a1a] text-sm">
//       <Header />
//       <header className="py-10 text-center bg-[#f3ead0]">
//         <h1 className="text-[30px] font-semibold">Cart</h1>
//         <nav className="text-xs text-[#6b5e3c] mt-3">
//           <ul className="inline-flex space-x-2 justify-center items-center">
//             <li><a className="hover:text-red-400 transition-colors duration-200" href="/">Home</a></li>
//             <li>|</li>
//             <li><a className="hover:text-red-400 transition-colors duration-200" href="#">Cart</a></li>
...
//         <h1 className="text-3xl font-semibold mb-6">Your Cart ({cartCount})</h1>
...
//                 <div className="col-span-2 flex justify-center items-center space-x-1 border border-[#d1d1d1] w-24 h-8 ml-14">
//                   <button
//                     onClick={() => updateQuantity(item.id, item.quantity - 1)}
...
//                 <div className="border-b border-[#d1d1d1] py-4 flex justify-end">
...
//                     <div className="text-xs text-[#4a4a4a] mb-2">
...
//                       <button
//                         type="button"
//                         className="text-xs text-[#4a4a4a] font-semibold mt-1 underline flex items-center space-x-1"
//                       >
...
//                       <select
//                         className="w-full text-xs rounded-md border border-[#d1d1d1] bg-[#f2f2f2] px-3 py-1"
//                         aria-label="Country"
//                       >
...
//                         className="w-full text-xs rounded-md border border-[#d1d1d1] bg-[#f2f2f2] px-3 py-1 placeholder-[#a1a1a1]"
//                       />
//                       <button
//                         type="submit"
//                         className="bg-[#ff0a0a] text-white text-xs font-semibold rounded-full px-5 py-2 float-right"
//                       >
//                         Update Details
//                       </button>
//                     </form>
