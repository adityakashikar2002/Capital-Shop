...
//               type="text"
//               placeholder="Username / Email address"
//               className={`w-full border ${errors.username ? 'border-red-500' : 'border-gray-300'} text-xs text-[#9B9B9B] placeholder-[#9B9B9B] px-4 py-3 focus:outline-none focus:ring-1 focus:ring-[#0B0B2B]`}
