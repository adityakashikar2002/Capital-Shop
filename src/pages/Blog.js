...
//   const categories = [
//     { name: "Luxury Brands", count: 24 },
//     { name: "Street Fashion", count: 18 },
//     { name: "Sustainable Fashion", count: 15 },
//     { name: "Accessories", count: 12 },
//     { name: "Seasonal Trends", count: 9 },
//     { name: "Fashion History", count: 7 }
//   ];
...
//   const tags = ["luxury", "trends", "sustainable", "streetwear", "accessories", "designer", "runway", "vintage"];
...
//             <button 
//                 aria-label="Previous" 
//                 className="border border-gray-200 rounded px-3 py-2 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300"
...
//                 className={`border border-gray-200 rounded px-4 py-2 ${currentPage === 1 ? 'bg-white text-gray-600 font-semibold' : 'hover:bg-gray-50 hover:text-gray-600'}`}
...
//                 className={`border border-gray-200 rounded px-4 py-2 ${currentPage === 2 ? 'bg-white text-gray-600 font-semibold' : 'hover:bg-gray-50 hover:text-gray-600'}`}
...
//             <button 
//                 aria-label="Next" 
//                 className="border border-gray-200 rounded px-3 py-2 hover:bg-gray-50 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-300"
...
//             <form className="flex">
//                 <input 
//                 className="flex-grow px-4 py-3 text-xs text-gray-400 border border-transparent focus:outline-none" 
...
//                 <li key={index} className="border-b border-gray-200 pb-2 flex justify-between">
