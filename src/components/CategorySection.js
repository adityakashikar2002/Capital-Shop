...
//         <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent text-white text-[20px] font-bold text-center py-3">
//           <p className='m-6'>Men's Fashion</p>
//         </div>
//       </div>
//       <div className="relative group cursor-pointer">
...
//              width="400"/>
//         <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent text-white text-[20px] font-bold text-center py-3">
//           <p className='m-6'>Women's Fashion</p>
//         </div>
//       </div>
//       <div className="relative group cursor-pointer">
...
//         <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent text-white text-[20px] font-bold text-center py-3">
//           <p className='m-6'>Baby Fashion</p>
//         </div>
//       </div>
//     </section>
//   );
