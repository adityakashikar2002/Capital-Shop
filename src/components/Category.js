...
const allProductItemsCategory = [
  ...
  {
    id: 13,
    image: 'https://img.freepik.com/free-psd/adorable-baby-onesie-with-elegant-black-white-floral-design_191095-81429.jpg',
  ...
  {
    id: 14,
    image: 'https://img.freepik.com/free-psd/adorable-baby-denim-overalls-blue-jean-outfit-little-ones_191095-85718.jpg',
        ...
        <section className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 mr-72 mt-20 mb-20">
          {filteredProducts.length > 0 ? (
            filteredProducts.map((item) => (
              <article
                key={item.id}
                className="text-center text-xs text-[#6b5e3c] relative cursor-pointer"
